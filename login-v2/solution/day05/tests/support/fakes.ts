...
import type { StoredCode, StoredSession, UserRow } from '../../src/modules/auth/domain/schemas/index'
...
export class InMemoryUserAccountStore implements UserAccountRepositoryPort {
