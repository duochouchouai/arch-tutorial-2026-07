...
import { registerSchema, loginSchema, forgotPasswordSchema, resetPasswordSchema, autoLoginSchema, oauthSchema } from './auth-schema';
...
import { OAuthLoginInput, OAuthLoginUseCase } from '../application/oauth-login';
